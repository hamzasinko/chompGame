...
static void getPosition(GtkWidget *widget, gpointer data) {
...
static void activate(GtkApplication *app, gpointer user_data) {
    ...
    // Create and add the game table to the box
    creationTableJeu(box);

    // Create and add a quit button to the box
